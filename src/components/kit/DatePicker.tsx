    ...
    <div className={`date-picker-wrapper ${className}`}>
      ...
      <div className="date-picker-day-container">
        <div className="date-picker-day-header">
          <span className="day-item">{"days.mon"}</span>
          <span className="day-item">{"days.tue"}</span>
          <span className="day-item">{"days.wed"}</span>
          <span className="day-item">{"days.thu"}</span>
          <span className="day-item">{"days.fri"}</span>
          <span className="day-item">{"days.sat"}</span>
          <span className="day-item">{"days.sun"}</span>
        </div>
