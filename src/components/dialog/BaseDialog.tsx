...
import { ANIMATION_DURATION } from "@/helper/consts"
import store from "@/store"
import { useDialogStore } from "@/store/dialog"
import "@/components/css/base-dialog.less"
...
function BaseDialog(props: Props) {
    ...
    const dialogIndex = dialogStore.state.dialogStack.findIndex((item: string) => item === dialogName);
